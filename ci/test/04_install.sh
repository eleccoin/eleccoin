...
if [ ! -d ${DIR_QA_ASSETS} ]; then
  git clone https://github.com/eleccoin-core/qa-assets ${DIR_QA_ASSETS}
fi
...
env | grep -E '^(ELECCOIN_CONFIG|CCACHE_|WINEDEBUG|LC_ALL|BOOST_TEST_RANDOM|CONFIG_SHELL|(ASAN|LSAN|TSAN|UBSAN)_OPTIONS)' | tee /tmp/env
