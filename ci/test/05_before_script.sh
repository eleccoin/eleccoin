...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Eleccoin
else
  DOCKER_EXEC echo \> \$HOME/.eleccoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/eleccoin/eleccoin/pull/18288#discussion_r433189350 for
  # details.
