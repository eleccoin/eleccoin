...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/eleccoin/eleccoin/pull/14884#discussion_r239585126).
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to `True` to
  ...
  mature block subsidies (25x50=1250 ECC) in its wallet. Using them is much more
...
with the eleccoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a eleccoind.  `P2PInterface`
...
The [`TestShell`](test-shell.md) class exposes the EleccoinTestFramework
...
Taken from the [python-eleccoinrpc repository](https://github.com/jgarzik/python-eleccoinrpc).
