...
class RawTransactionsTest(EleccoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid eleccoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        # output 0 takes at least as much share of the fee, and no more than 2 electrons more, than outputs 2 and 3
