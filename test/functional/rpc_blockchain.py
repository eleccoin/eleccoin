...
class BlockchainTest(EleccoinTestFramework):
    ...
    def mine_chain(self):
        ...
        for t in range(TIME_GENESIS_BLOCK, TIME_GENESIS_BLOCK + 200 * 600, 600):
            ...
            self.nodes[0].generatetoaddress(1, ADDRESS_ECRT1_P2WSH_OP_TRUE)
    ...
    def _test_stopatheight(self):
        ...
        self.nodes[0].generatetoaddress(6, ADDRESS_ECRT1_P2WSH_OP_TRUE)
