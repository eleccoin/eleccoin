...
from test_framework.address import ADDRESS_ECRT1_UNSPENDABLE as ADDRESS_WATCHONLY
...
class WalletTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 40 ECC from 0 to 1 and 60 ECC from 1 to 0.
        ...
        # ECC, which is more than would be available if transaction 1 were
        # replaced.
