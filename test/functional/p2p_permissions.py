...
from test_framework.address import ADDRESS_ECRT1_P2WSH_OP_TRUE
...
class P2PPermissionsTests(EleccoinTestFramework):
    ...
    def check_tx_relay(self):
        block_op_true = self.nodes[0].getblock(self.nodes[0].generatetoaddress(100, ADDRESS_ECRT1_P2WSH_OP_TRUE)[0])
        self.sync_all()
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].eleccoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].eleccoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
