...
from test_framework.address import ADDRESS_ECRT1_UNSPENDABLE
...
class NotificationsTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        block_count = 10
        blocks = self.nodes[1].generatetoaddress(block_count, self.nodes[1].getnewaddress() if self.is_wallet_compiled() else ADDRESS_ECRT1_UNSPENDABLE)
        ...
        if self.is_wallet_compiled():
            ...
            self.nodes[0].generatetoaddress(100, ADDRESS_ECRT1_UNSPENDABLE)
            self.sync_blocks()

            # Generate transaction on node 0, sync mempools, and check for
            # notification on node 1.
            tx1 = self.nodes[0].sendtoaddress(address=ADDRESS_ECRT1_UNSPENDABLE, amount=1, replaceable=True)
            ...
            # https://github.com/eleccoin/eleccoin/pull/9371, it might be better
            ...
            blockhash1 = self.nodes[0].generatetoaddress(1, ADDRESS_ECRT1_UNSPENDABLE)[0]
            ...
            tx2 = self.nodes[0].sendtoaddress(address=ADDRESS_ECRT1_UNSPENDABLE, amount=1, replaceable=True)
            ...
            blockhash2 = self.nodes[0].generatetoaddress(1, ADDRESS_ECRT1_UNSPENDABLE)[0]
