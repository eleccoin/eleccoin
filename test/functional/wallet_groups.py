...
class WalletGroupTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        # Sending 1.4 ecc should pick one 1.0 + one more. For node #1,
        ...
        # 1 ele higher, crossing the threshold from non-grouped to grouped.
