...
class WalletLabelsTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Eleccoins
        ...
        if self.options.descriptors:
            ...
            BECH32_VALID = {
                '✔️_VER15_PROG40': 'ecrt10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxkg7fn',
                '✔️_VER16_PROG03': 'ecrt1sqqqqq8uhdgr',
                '✔️_VER16_PROB02': 'ecrt1sqqqq4wstyw',
            }
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'ecrt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8',
                '❌_VER16_PROB01': 'ecrt1sqq5r4036',
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Eleccoin address or script",
