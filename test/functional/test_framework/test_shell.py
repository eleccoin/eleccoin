...
class TestShell:
    """Wrapper Class for EleccoinTestFramework.

    The TestShell class extends the EleccoinTestFramework
    ...
    class __TestShell(EleccoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by EleccoinTestFramework child class.
            self.num_nodes = 1
