...
class MiniWallet:
    def __init__(self, test_node, *, mode=MiniWalletMode.ADDRESS_OP_TRUE):
        ...
        if mode == MiniWalletMode.RAW_OP_TRUE:
            ...
            self._address = ADDRESS_ECRT1_P2WSH_OP_TRUE
    ...
    def create_self_transfer(self, *, fee_rate=Decimal("0.003"), from_node, utxo_to_spend=None, mempool_valid=True, locktime=0, sequence=0):
        """Create and return a tx with the specified fee_rate. Fee may be exact or at most one electron higher than needed."""
        ...
        send_value = electron_round(utxo_to_spend['value'] - fee_rate * (vsize / 1000))
