...
"""Encode and decode Eleccoin addresses.
...
ADDRESS_ECRT1_UNSPENDABLE = 'ecrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj'
ADDRESS_ECRT1_UNSPENDABLE_DESCRIPTOR = 'addr(ecrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj)#juyq9d97'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_ECRT1_P2WSH_OP_TRUE = 'ecrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqseac85'
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("bc" if main else "ecrt", version, program)
