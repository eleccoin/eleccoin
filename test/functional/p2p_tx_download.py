...
class TxDownloadTest(EleccoinTestFramework):
    ...
    def test_inv_block(self):
        ...
        tx = self.nodes[0].createrawtransaction(
            ...
            outputs={ADDRESS_ECRT1_UNSPENDABLE: 50 - 0.00025},
        )
    ...
    def run_test(self):
        ...
        # Run each test against new eleccoind instances, as setting mocktimes has long-term effects on when
