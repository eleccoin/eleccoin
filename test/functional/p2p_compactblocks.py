...
# TestP2PConn: A peer we use to send messages to eleccoind, and store responses.
...
class CompactBlocksTest(EleccoinTestFramework):
    ...
    # This test actually causes eleccoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that eleccoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for eleccoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # eleccoind will not send blocktxn responses for blocks whose height is
