...
"""Verify that starting eleccoin with -h works as expected."""

from test_framework.test_framework import EleccoinTestFramework
from test_framework.util import assert_equal

class HelpTest(EleccoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eleccoin with -h for help text")
        ...
        self.log.info("Start eleccoin with -version for version information")
        ...
        self.log.info("Start eleccoind with -fakearg to make sure it does not start")
