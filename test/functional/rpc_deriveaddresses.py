...
class DeriveaddressesTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "ecrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr34acd5"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["ecrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "ecrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "ecrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "ecrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
