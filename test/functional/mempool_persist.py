...
By default, eleccoind will dump mempool on shutdown and
...
class MempoolPersistTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent eleccoind from writing mempool.dat to disk. Verify that `savemempool` fails")
