...
test/get_previous_releases.py -b v1.2.1 v1.2.0
...
class BackwardsCompatibilityTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        # Copy the 0.16 wallet to the last Eleccoin Core version and open it:
        shutil.copyfile(
            os.path.join(node_v16_wallets_dir, "wallets/u1_v16"),
            os.path.join(node_master_wallets_dir, "u1_v16")
        )
        load_res = node_master.loadwallet("u1_v16")
        # Make sure this wallet opens without warnings. See https://github.com/eleccoin/eleccoin/pull/19054
