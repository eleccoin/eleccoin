...
Verify that a eleccoind node can use an external signer command.
...
class RPCSignerTest(EleccoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart eleccoind with -signer=<cmd>',
