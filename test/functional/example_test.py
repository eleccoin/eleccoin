...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the EleccoinTestFramework
    pass


class ExampleTest(EleccoinTestFramework):
    # Each functional test is a subclass of the EleccoinTestFramework class.
    ...
    def custom_method(self):
        ...
        EleccoinTestFramework class so other tests can use it."""
