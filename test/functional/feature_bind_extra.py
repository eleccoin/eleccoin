...
"""
Test starting eleccoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(EleccoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that eleccoind has bound on "::1" (for RPC) and "::" (for P2P).
