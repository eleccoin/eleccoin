Contributing to Eleccoin Core
============================

The Eleccoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Eleccoin Core build
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to eleccoin-qt
...
fork of Eleccoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/eleccoin/eleccoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Eleccoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Eleccoin
Network Protocol consensus changes.

Whether a pull request is merged into Eleccoin Core rests with the project merge
...
Patches that change Eleccoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Eleccoin consensus, it must have been
...
The project leader is the release manager for each Eleccoin Core release.
