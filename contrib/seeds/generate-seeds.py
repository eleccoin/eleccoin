...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ELECCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ELECCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the eleccoin network\n')
    ...
    g.write('#endif // ELECCOIN_CHAINPARAMSSEEDS_H\n')
