...
"""Example logging Eleccoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/eleccoind
...
def main(eleccoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[eleccoind_with_usdts])
