...
When complete, it will have produced `Eleccoin-Qt.dmg`.
...
apt install cpio
git clone https://github.com/eleccoin-core/apple-sdk-tools.git
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/eleccoin/eleccoin/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
