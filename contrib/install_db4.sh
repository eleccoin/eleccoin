...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the eleccoin repository."
  exit 1
fi
...
# See https://github.com/eleccoin/eleccoin/issues/16064
...
echo 'When compiling eleccoind, run `./configure` in the following way:'
echo
