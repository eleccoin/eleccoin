...
# Deterministically build Eleccoin Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/electron/eleccoin/' to
        #     '/home/electron/eleccoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/eleccoin
        #
        #                     maps our current working directory to /eleccoin
        ...
        #     container so that we have something to build. '/eleccoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /eleccoin && bash contrib/guix/libexec/build.sh"
    )
