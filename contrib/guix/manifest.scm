...
(define* (make-eleccoin-cross-toolchain target
                                  #:key
...
desirable for building Eleccoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-eleccoin-cross-toolchain "i686-linux-gnu")
       (make-eleccoin-cross-toolchain "x86_64-linux-gnu")
       (make-eleccoin-cross-toolchain "aarch64-linux-gnu")
       (make-eleccoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-eleccoin-cross-toolchain "riscv64-linux-gnu"
