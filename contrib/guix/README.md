# Bootstrappable Eleccoin Core Builds

This directory contains the files necessary to perform bootstrappable Eleccoin
Core builds.
...
- 24GB of free disk space on the partition that the Eleccoin Core git repository
  resides in
...
For a Eleccoin Core depends development environment, simply invoke
...
From the top of a clean Eleccoin Core repository:
...
To use dongcarl's substitute server for Eleccoin Core builds after having
