...
#ifndef ELECCOIN_NET_H
#define ELECCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/eleccoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Eleccoin’s Peer-to-Peer Network")
...
public:
     ...
     * @see https://github.com/eleccoin/eleccoin/issues/21744 for details.
     */
