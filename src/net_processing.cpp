        ...
        m_connman.ForNode(nodeid, [this](CNode* pfrom) EXCLUSIVE_LOCKS_REQUIRED(::cs_main) {
            ...
            if (lNodesAnnouncingHeaderAndIDs.size() >= 3) {
                ...
                m_connman.ForNode(lNodesAnnouncingHeaderAndIDs.front(), [this, nCMPCTBLOCKVersion](CNode* pnodeStop){
                    ...
                    pnodeStop->m_eip152_highbandwidth_to = false;
                    return true;
                });
            ...
            pfrom->m_eip152_highbandwidth_to = true;
    ...
    while (!orphan_work_set.empty()) {
        ...
        if (result.m_result_type == MempoolAcceptResult::ResultType::VALID) {
            ...
            if (state.GetResult() != TxValidationResult::TX_WITNESS_STRIPPED) {
                ...
                // https://github.com/eleccoin/eleccoin/issues/8279 for details.
                // We can remove this restriction (and always add wtxids to
                // the filter even for witness stripped transactions) once
                // wtxid-based relay is broadly deployed.
                // See also comments in https://github.com/eleccoin/eleccoin/pull/18044#discussion_r443419034
    ...
    if (msg_type == NetMsgType::SENDCMPCT) {
        ...
        if (nCMPCTBLOCKVersion == 1 || ((pfrom.GetLocalServices() & NODE_WITNESS) && nCMPCTBLOCKVersion == 2)) {
            ...
            if (State(pfrom.GetId())->fWantsCmpctWitness == (nCMPCTBLOCKVersion == 2)) { // ignore later version announces
                ...
                pfrom.m_eip152_highbandwidth_from = fAnnounceUsingCMPCTBLOCK;
            }
