...
static void SetupEleccoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " eleccoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  eleccoin-tx [options] <hex-tx> [commands]  Update hex-encoded eleccoin transaction\n" +
            "or:     eleccoin-tx [options] -create [commands]   Create hex-encoded eleccoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eleccoin transaction
