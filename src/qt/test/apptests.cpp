...
void AppTests::appTests()
{
    ...
    connect(&m_app, &EleccoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for EleccoinGUI tests.
void AppTests::guiTests(EleccoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &EleccoinGUI::consoleShown, this, &AppTests::consoleTests);
