    ...
    mapper(nullptr)
{
    ...
    ui->eleccoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->eleccoinAtStartup);
    ...
    ui->eleccoinAtStartup->setToolTip(ui->eleccoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->eleccoinAtStartup->setText(ui->eleccoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openEleccoinConfButton->setToolTip(ui->openEleccoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new EleccoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->eleccoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSECControls);
...
void OptionsDialog::on_openEleccoinConfButton_clicked()
{
