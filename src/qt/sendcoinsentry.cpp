    ...
    platformStyle(_platformStyle)
{
    ...
    // normal eleccoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying eleccoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &EleccoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
