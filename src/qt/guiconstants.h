...
#ifndef ELECCOIN_QT_GUICONSTANTS_H
#define ELECCOIN_QT_GUICONSTANTS_H
...
/* EleccoinGUI -- Size of icons in status bar */
...
#endif // ELECCOIN_QT_GUICONSTANTS_H
