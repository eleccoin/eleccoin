...
#ifndef ELECCOIN_QT_GUIUTIL_H
#define ELECCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Eleccoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "eleccoin:" URI into recipient object, return true on successful parsing
