...
#ifdef ENABLE_WALLET
    if(enableWallet) {
        connect(walletFrame, &WalletFrame::requestedSyncWarningInfo, this, &EleccoinGUI::showModalOverlay);
...
void EleccoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a eleccoin: URI or payment request"));
...
void EleccoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &EleccoinGUI::setCurrentWalletBySelectorIndex);
...
void EleccoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        if (optionsModel && trayIcon) {
            ...
            connect(optionsModel, &OptionsModel::hideTrayIconChanged, this, &EleccoinGUI::setTrayIconVisible);
...
void EleccoinGUI::setWalletController(WalletController* wallet_controller)
{
    ...
    connect(wallet_controller, &WalletController::walletAdded, this, &EleccoinGUI::addWallet);
...
void EleccoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Eleccoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void EleccoinGUI::setNetworkActive(bool networkActive)
{
    updateNetworkState();
}
...
void EleccoinGUI::setTrayIconVisible(bool fHideTrayIcon)
{
    if (trayIcon)
    {
...
void UnitDisplayStatusBarControl::createContextMenu()
{
    ...
    {
        QAction *menuAction = new QAction(QString(EleccoinUnits::longName(u)), this);
