...
void EleccoinGUI::createActions()
{
    ...
    connect(quitAction, &QAction::triggered, this, &EleccoinGUI::quitRequested);
...
void EleccoinGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &EleccoinGUI::toggleHidden);
...
void EleccoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    ...
    connect(dlg, &OptionsDialog::quitOnReset, this, &EleccoinGUI::quitRequested);
