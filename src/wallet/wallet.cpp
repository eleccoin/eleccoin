...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/eleccoin/eleccoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/eleccoin/eleccoin/pull/13339#issuecomment-461288094
    ...
    while (!fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, FoundBlock().data(block)) && !block.IsNull()) {
            ...
            if (reorg) {
                ...
                // https://github.com/eleccoin/eleccoin/pull/14711#issuecomment-458342518
        ...
        bool sign)
{
    ...
    int nBytes;
    {
        ...
        txNew.nLockTime = GetLocktimeForNewTransaction(chain(), GetLastBlockHash(), GetLastBlockHeight());
        {
            ...
            // change transaction isn't always pay-to-eleccoin-address
            ...
            if (coin_control.m_feerate && nFeeRateNeeded > *coin_control.m_feerate) {
                error = strprintf(_("Fee rate (%s) is lower than the minimum fee rate setting (%s)"), coin_control.m_feerate->ToString(FeeEstimateMode::ELE_VB), nFeeRateNeeded.ToString(FeeEstimateMode::ELE_VB));
                return false;
            }
 ...
 * https://eleccointalk.org/?topic=54527, or
 * https://github.com/eleccoin/eleccoin/pull/1393.
 */
