...
//! Discourage users to set fees higher than this amount (in electrons) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in electrons)
...
enum WalletFlags : uint64_t {
    ...
    //! eleccoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Eleccoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this eleccoin node, and set to 0 for transactions that were created
...
public:
    ...
    /** Absolute maximum transaction fee (in electrons) used by default for the wallet */
...
#endif // ELECCOIN_WALLET_WALLET_H
