...
#ifndef ELECCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ELECCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ELECCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
