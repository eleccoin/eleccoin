...
#ifndef ELECCOIN_WALLET_ISMINE_H
#define ELECCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/eleccoin/eleccoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // ELECCOIN_WALLET_ISMINE_H
