...
#ifndef ELECCOIN_UTIL_SYSCALL_SANDBOX_H
#define ELECCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during eleccoind initialization if Eleccoin Core was compiled
...
#endif // ELECCOIN_UTIL_SYSCALL_SANDBOX_H
