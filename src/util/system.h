 ...
 */
#ifndef ELECCOIN_UTIL_SYSTEM_H
#define ELECCOIN_UTIL_SYSTEM_H
...
extern const char * const ELECCOIN_CONF_FILENAME;
extern const char * const ELECCOIN_SETTINGS_FILENAME;
