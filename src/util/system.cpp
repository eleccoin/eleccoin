...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Eleccoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Eleccoin
    // Mac: ~/Library/Application Support/Eleccoin
    // Unix: ~/.eleccoin
#ifdef WIN32
    // Windows
