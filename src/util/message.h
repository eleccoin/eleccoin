...
// Copyright (c) 2009-2020 The Eleccoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ELECCOIN_UTIL_MESSAGE_H
#define ELECCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's eleccoin address, it must refer to a public key.
