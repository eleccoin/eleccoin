...
{
    return AbsPathForConfigVal(fs::path(args.GetArg("-pid", ELECCOIN_PID_FILENAME)));
}
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/eleccoin/eleccoin>";
...
/** Sanity checks
 *  Ensure that Eleccoin is running in a usable environment with all
...
bool AppInitMain(const util::Ref& context, NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    fs::path config_file_path = GetConfigFile(args.GetArg("-conf", ELECCOIN_CONF_FILENAME));
