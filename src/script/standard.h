...
#ifndef ELECCOIN_SCRIPT_STANDARD_H
#define ELECCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a eleccoin address
 */
...
/**
 * Generate a Eleccoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ELECCOIN_SCRIPT_STANDARD_H
