...
{
    BOOST_CHECK(TestSplitHost("www.eleccoincore.org", "www.eleccoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.eleccoincore.org]", "www.eleccoincore.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9833", "::ffff:127.0.0.1", 9833));
    BOOST_CHECK(TestSplitHost("[::]:9833", "::", 9833));
    BOOST_CHECK(TestSplitHost("::9833", "::9833", 0));
    BOOST_CHECK(TestSplitHost(":9833", "", 9833));
    BOOST_CHECK(TestSplitHost("[]:9833", "", 9833));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9833", "127.0.0.1:9833"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9833", "[::]:9833"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
