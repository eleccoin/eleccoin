...
#ifndef ELECCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ELECCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@eleccoin.
 *
 ...
 *
 * The chacha20-poly1305@eleccoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@eleccoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@eleccoin are relatively fast in
...
#endif // ELECCOIN_CRYPTO_CHACHA_POLY_AEAD_H
