...
#ifndef ELECCOIN_INTERFACES_INIT_H
#define ELECCOIN_INTERFACES_INIT_H
...
//! (eleccoin-gui, eleccoin-node, eleccoin-wallet, eleccoind, eleccoin-qt) and each
...
#endif // ELECCOIN_INTERFACES_INIT_H
