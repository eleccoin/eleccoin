dnl Copyright (c) 2020-2022 The Eleccoin Core developers
...
AC_DEFUN([ELECCOIN_QT_FAIL],[
  if test "$eleccoin_qt_want_version" = "auto" && test "$eleccoin_qt_force" != "yes"; then
    if test "$eleccoin_enable_qt" != "no"; then
...
AC_DEFUN([ELECCOIN_QT_CHECK],[
  if test "$eleccoin_enable_qt" != "no" && test "$eleccoin_qt_want_version" != "no"; then
    true
    $1
  else
    true
...
AC_DEFUN([ELECCOIN_QT_INIT],[
  ...
  AC_ARG_WITH([gui],
    ...
    [
     ...
     if test "$eleccoin_qt_want_version" = "yes"; then
...
AC_DEFUN([ELECCOIN_QT_CONFIGURE],[
  ...
  if test "$eleccoin_cv_static_qt" = "yes"; then
  ...
  if test $eleccoin_enable_qt = "yes"; then
