...
Eleccoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Run with the `-testnet` option to run with "play eleccoins" on the test network, if you
...
profiling. The repo contains a Valgrind suppressions file valgrind.supp
...
- src/crypto/ctaes
  - Upstream at https://github.com/eleccoin-core/ctaes ; actively maintained by Core contributors.

- src/univalue
  - Upstream at https://github.com/eleccoin-core/univalue ; actively maintained by Core contributors, deviates from upstream https://github.com/jgarzik/univalue
