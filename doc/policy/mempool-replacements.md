...
1. The directly conflicting transactions all signal replaceability explicitly. A transaction is
   ...
   *Rationale*: See [BIP125
   explanation](https://github.com/eleccoin/bips/blob/master/bip-0125.mediawiki#motivation).
...
4. The additional fees (difference between absolute fee paid by the replacement transaction and the
   ...
   replacement pays a fee at least 500 electrons higher than the sum of the original transactions.
...
* Opt-in full replace-by-fee (without inherited signaling) honoured in mempool and mining as of
  **v0.12.0** ([PR 6871](https://github.com/eleccoin/eleccoin/pull/6871)).

* [BIP125](https://github.com/eleccoin/bips/blob/master/bip-0125.mediawiki) defined based on
  Eleccoin Core implementation.
...
* The incremental relay feerate used to calculate the required additional fees is distinct from
  ...
  ([PR #9380](https://github.com/eleccoin/eleccoin/pull/9380)).

* RBF enabled by default in the wallet GUI as of **v0.18.1** ([PR
  #11605](https://github.com/eleccoin/eleccoin/pull/11605)).
