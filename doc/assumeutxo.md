...
Assumeutxo is a feature that allows fast bootstrapping of a validating eleccoind
...
- [Github issue](https://github.com/eleccoin/eleccoin/issues/15605)
- [draft PR](https://github.com/eleccoin/eleccoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for eleccoind.
...
**Failure consideration:** if eleccoind unexpectedly halts after `m_stop_use` is set on
...
### Eleccoind restarts sometime after snapshot validation has completed

When eleccoind initializes again, what began as the snapshot chainstate is now
