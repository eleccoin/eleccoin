...
This document provides guidelines for internationalization of the Eleccoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eleccoin_en.ts` remains unchanged.
