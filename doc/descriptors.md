# Support for Output Descriptors in Eleccoin Core
...
- Followed by the actual key, which is either:
  ...
  - [WIF](https://en.eleccoin.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
...
- Segwit addresses (bech32 and bech32m, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/eleccoin/bips/blob/master/bip-0173.mediawiki) and [BIP 350](https://github.com/eleccoin/bips/blob/master/bip-0350.mediawiki)).
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Eleccoin Core descriptor wallet to serve as your
...
the entire path from the master down. [BIP174](https://github.com/eleccoin/bips/blob/master/bip-0174.mediawiki) standardizes this by
